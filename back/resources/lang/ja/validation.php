...
return [
    ...
    */
    ...
    'not_in'               => ':attributeが無効な値です',
    'not_regex'            => 'The :attribute format is invalid.',
    'numeric'              => ':attributeは数字のみ有効です',
    'password' => [
        'letters' => ':attribute は文字を1文字以上含むのが必須です',
        'mixed' => ':attribute は大文字・小文字それぞれ1文字以上が必須です',
        'min' => ':attributeは 8 ~ 24文字で入力してください',
        'numbers' => ':attribute は数字を1文字以上含むのが必須です',
        'symbols' => ':attribute は記号を1文字以上含むのが必須です',
        'uncompromised' => ':attribute に個人情報が含まれています。個人情報を含まない値にしてください',
    ],
